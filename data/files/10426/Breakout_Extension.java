 ...
 * ---------------------------------
 * This file extends the Breakout file by adding sounds to the game.
 */
...
public class Breakout_Extension extends GraphicsProgram {
	 ...
	 * ----------------------------
	 * Checks for collisions of the ball with the paddle and bricks. Adds a bouncing sound
	 * for each time there is a collision. If the ball collides with the paddle, it bounces off. 
	 * If it collides with a brick it also bounces off and brick is removed. 
	 */
