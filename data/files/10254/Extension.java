...
public class Extension extends GraphicsProgram {
	...
	private GLabel lose = new GLabel("You Lost :(");
	private GLabel win = new GLabel("You Won! :)");
	private GLabel click = new GLabel("Please Click to Start");
	...
	/*
	 * Prints message label
	 */
	private void addMessage(GLabel message) {
		double xOrigin = (getWidth() - message.getWidth()) / 2;
		double yOrigin = (getHeight() - message.getHeight()) / 2;
		
		add(message, xOrigin, yOrigin);
	}
}
