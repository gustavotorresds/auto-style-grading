...
public class Breakout extends GraphicsProgram {
	...
	// Sets up the screen with a title, specific canvas size, bricks, and paddle
	private void setUp() {
	...
	// Plays game. Sets up ball in screen, gives it a speed, plays game
	...
	// Returns the object that has been collided with at any of the ball's four corners if a box were drawn around it
	...
	// Returns true if paddle is too far to the right such that it would be off the screen
	...
	// Returns true if paddle is too far to the left such that it would be off the screen
