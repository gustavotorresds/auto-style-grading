...
public class Breakout extends GraphicsProgram {
	...
	// the paddle moves back and forth across the screen along with the mouse 
	// until it reaches the edge of its space
	...
	// plays game until player wins or loses the game
