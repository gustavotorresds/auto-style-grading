...
public class BreakoutFinal2 extends GraphicsProgram {
	...
	private void handleCollidedObject() {
		...
		if(collider == paddle) {
			...
			/* If the object that the ball hits is not the paddle and not null, it must be a brick. This removes the brick from the screen and also 
