 ...
 * 
 * This program runs a game called Breakout, 
 * in which the player moves paddle to hit the ball
 * and the ball breaks the bricks. The goal is to 
 * remove all the bricks in three turns. 
 */
...
public class Breakout extends GraphicsProgram {
	...
	/*
	 * Sets bricks, creates paddle and follows the mouse,
	 * creates ball, and ball bounces off walls and the 
	 * paddle while removing bricks when hit. 
	 */
	public void run() {
		...
		// Moves ball, removes bricks, and ends game
		moveBall();
	}
