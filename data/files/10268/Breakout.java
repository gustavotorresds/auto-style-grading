 ...
 * 
 * This program utilizes mouse listeners, sets up the game 'Breakout' and allows 
 * the user to play the game with the opportunity to win and lose. 
 */
...
public class Breakout extends GraphicsProgram {
	 ...
	 * velocity and takes it away from the brick count.
	 *  
	 *  pre: ball does not move
	 *  post: game is live and ball moves, bounces, and removes bricks
	 */
