...
public class BasicBreakout extends GraphicsProgram {
	...
	public void run() {
		...
		//creates game board
		setUpGame();
		//plays Breakout until three lives have been used or the game player removes all 100 bricks
		playBreakout();
	...
	private void setUpColoredBricks() {
		...
		//generates the bricks in the y-direction for ten rows, changing the colors every two rows
		...
		//centers the paddle in the bottom of the screen with an offset in the Y direction
